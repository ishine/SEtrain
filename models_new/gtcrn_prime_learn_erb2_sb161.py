...
try:
    from .modules.layers import LearnableFB, SFE, ConvBlock, Mask
    from .modules.gtconv import GTConvBlock
    from .modules.rnn import DPGRNN
except ImportError:
    from modules.layers import LearnableFB, SFE, ConvBlock, Mask
    from modules.gtconv import GTConvBlock
    from modules.rnn import DPGRNN
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("ptflops not installed or error")
