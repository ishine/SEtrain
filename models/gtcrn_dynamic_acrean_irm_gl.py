...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.en_convs = nn.ModuleList([
            # F: 129 -> 65
            BConvBlock(1*3, CHANNELS, (1,5), stride=(1,2), padding=(0,2), use_deconv=False, is_last=False, bands=2, f_out=65),
            # F: 65 -> 33
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.de_convs = nn.ModuleList([
            ...
            # F: 65 -> 129
            BConvBlock(CHANNELS, 1, (1,5), stride=(1,2), padding=(0,2), use_deconv=True, is_last=True, bands=2, f_out=129)
        ])
...
class GTCRN(nn.Module):
    ...
    def forward(self, x):
        ...
        feat = spec_mag.unsqueeze(1)  # (B,1,T,257)
