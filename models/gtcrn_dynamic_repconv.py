...
class GTConvBlock(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, kernel_size, stride, padding, dilation, kernel_choices=8, use_deconv=False):
        ...
        self.conv = RepConvBlock(in_channels//2, hidden_channels//2, kernel_size=kernel_size, stride=stride, padding=padding, dilation=dilation, is_last=False, use_deconv=use_deconv)
...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.en_convs = nn.ModuleList([
            ...
            RepConvBlock(CHANNELS, CHANNELS, (3,3), stride=(1,1), padding=(0,1), dilation=(1,1), use_deconv=False),
            RepConvBlock(CHANNELS, CHANNELS, (3,3), stride=(1,1), padding=(0,1), dilation=(2,1), use_deconv=False),
            RepConvBlock(CHANNELS, CHANNELS, (3,3), stride=(1,1), padding=(0,1), dilation=(5,1), use_deconv=False)
        ])
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.de_convs = nn.ModuleList([
            RepConvBlock(CHANNELS, CHANNELS, (3,3), stride=(1,1), padding=(5*2,1), dilation=(5,1), use_deconv=True),
            RepConvBlock(CHANNELS, CHANNELS, (3,3), stride=(1,1), padding=(2*2,1), dilation=(2,1), use_deconv=True),
            RepConvBlock(CHANNELS, CHANNELS, (3,3), stride=(1,1), padding=(1*2,1), dilation=(1,1), use_deconv=True),
