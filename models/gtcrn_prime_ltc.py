...
class GTCRN(nn.Module):
    def __init__(
        ...
        self.dpgrnn3 = DPGRNN(CHANNELS, 33, CHANNELS)
        self.dpgrnn4 = DPGRNN(CHANNELS, 33, CHANNELS)
    ...
    def forward(self, x):
        ...
        with record_function("DPGRNN"):
            ...
            feat = self.dpgrnn3(feat) # (B,CHANNELS,T,33)
            feat = self.dpgrnn4(feat) # (B,CHANNELS,T,33)
